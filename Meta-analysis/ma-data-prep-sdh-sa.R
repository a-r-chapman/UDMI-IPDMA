        ...
        for (outcome in outcomes) {
                for (model in models) {
                        ...
                        if (outcome == "hf" || outcome == "acd") {
                                ...
                                pattern_file <- glue("fg_{outcome}_sa_adj_primary_model_fu_{time}")
                        } else {
                                pattern_file <- glue("fg_{outcome}_sa_{model}_fu_{time}")
                        }
                        ...
                        write.csv(sHR_pool, glue("Tables/sh/{time}/combined_sHR_sa_{outcome}_{time}_{model}.csv"), row.names = FALSE)
