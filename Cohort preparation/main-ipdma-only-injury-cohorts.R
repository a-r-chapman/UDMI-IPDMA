# Main File for cohorts including ONLY patients with injury 
...
# If you have 5 year follow up available, please re run scripts from line 23 below to 36 with "5y" rather than "1y" (default)
